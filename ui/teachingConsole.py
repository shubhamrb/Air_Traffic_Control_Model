...
class Ui_teachingConsole(object):
    def setupUi(self, teachingConsole):
        ...
        teachingConsole.resize(745, 508)
        self.horizontalLayout_12 = QtWidgets.QHBoxLayout(teachingConsole)
        ...
        self.frame = QtWidgets.QFrame(self.selectedAircraft_box)
        self.frame.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.frame.setObjectName("frame")
        self.horizontalLayout_2 = QtWidgets.QHBoxLayout(self.frame)
        self.horizontalLayout_2.setObjectName("horizontalLayout_2")
        self.selectedCallsign_info = QtWidgets.QLabel(self.frame)
        font = QtGui.QFont()
        font.setPointSize(14)
        font.setBold(True)
        font.setWeight(75)
        self.selectedCallsign_info.setFont(font)
        ...
        self.spawn_button = QtWidgets.QToolButton(self.frame)
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        ...
        self.freezeACFT_button = QtWidgets.QToolButton(self.frame)
        ...
        self.kill_button = QtWidgets.QToolButton(self.frame)
        ...
        self.horizontalLayout_7.addWidget(self.squawkVFR_button)
        ...
        self.cpdlc_stackedWidget = QtWidgets.QStackedWidget(self.groupBox_5)
        self.cpdlc_stackedWidget.setObjectName("cpdlc_stackedWidget")
        self.cpdlc_connect_page = QtWidgets.QWidget()
        self.cpdlc_connect_page.setObjectName("cpdlc_connect_page")
        self.horizontalLayout_8 = QtWidgets.QHBoxLayout(self.cpdlc_connect_page)
        self.horizontalLayout_8.setContentsMargins(0, 0, 0, 0)
        self.horizontalLayout_8.setObjectName("horizontalLayout_8")
        self.label_8 = QtWidgets.QLabel(self.cpdlc_connect_page)
        self.label_8.setObjectName("label_8")
        self.horizontalLayout_8.addWidget(self.label_8)
        self.cpdlcLogOn_button = QtWidgets.QToolButton(self.cpdlc_connect_page)
        self.cpdlcLogOn_button.setObjectName("cpdlcLogOn_button")
        self.horizontalLayout_8.addWidget(self.cpdlcLogOn_button)
        self.cpdlcTransfer_button = QtWidgets.QToolButton(self.cpdlc_connect_page)
        self.cpdlcTransfer_button.setObjectName("cpdlcTransfer_button")
        self.horizontalLayout_8.addWidget(self.cpdlcTransfer_button)
        self.cpdlc_stackedWidget.addWidget(self.cpdlc_connect_page)
        self.cpdlc_connected_page = QtWidgets.QWidget()
        self.cpdlc_connected_page.setObjectName("cpdlc_connected_page")
        self.horizontalLayout_11 = QtWidgets.QHBoxLayout(self.cpdlc_connected_page)
        self.horizontalLayout_11.setContentsMargins(0, 0, 0, 0)
        self.horizontalLayout_11.setObjectName("horizontalLayout_11")
        self.cpdlcVectorRequest_toggle = QtWidgets.QPushButton(self.cpdlc_connected_page)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.cpdlcVectorRequest_toggle.sizePolicy().hasHeightForWidth())
        self.cpdlcVectorRequest_toggle.setSizePolicy(sizePolicy)
        self.cpdlcVectorRequest_toggle.setCheckable(True)
        self.cpdlcVectorRequest_toggle.setObjectName("cpdlcVectorRequest_toggle")
        self.horizontalLayout_11.addWidget(self.cpdlcVectorRequest_toggle)
        self.cpdlcVectorRequest_info = QtWidgets.QLabel(self.cpdlc_connected_page)
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        self.cpdlcVectorRequest_info.setFont(font)
        self.cpdlcVectorRequest_info.setObjectName("cpdlcVectorRequest_info")
        self.horizontalLayout_11.addWidget(self.cpdlcVectorRequest_info)
        self.cpdlc_stackedWidget.addWidget(self.cpdlc_connected_page)
        self.gridLayout_3.addWidget(self.cpdlc_stackedWidget, 0, 0, 1, 2)
        self.showDataLinkWindow_button = QtWidgets.QPushButton(self.groupBox_5)
        self.showDataLinkWindow_button.setObjectName("showDataLinkWindow_button")
        self.gridLayout_3.addWidget(self.showDataLinkWindow_button, 1, 1, 1, 1)
        ...
        self.horizontalLayout_12.addWidget(self.selectedAircraft_box)
        self.sessionOptions_box = QtWidgets.QGroupBox(teachingConsole)
        self.sessionOptions_box.setObjectName("sessionOptions_box")
        self.verticalLayout = QtWidgets.QVBoxLayout(self.sessionOptions_box)
        self.verticalLayout.setObjectName("verticalLayout")
        self.tabWidget = QtWidgets.QTabWidget(self.sessionOptions_box)
        ...
        self.visibility_edit.setWrapping(True)
        ...
        self.wind_widget = QtWidgets.QWidget(self.tab_2)
        self.wind_widget.setObjectName("wind_widget")
        self.gridLayout_4 = QtWidgets.QGridLayout(self.wind_widget)
        self.gridLayout_4.setObjectName("gridLayout_4")
        self.verticalLayout_4.addWidget(self.wind_widget)
        ...
        self.touchDownWithoutClearance_tickBox = QtWidgets.QCheckBox(self.sessionOptions_box)
        self.touchDownWithoutClearance_tickBox.setObjectName("touchDownWithoutClearance_tickBox")
        self.verticalLayout.addWidget(self.touchDownWithoutClearance_tickBox)
        self.pauseSim_button = QtWidgets.QPushButton(self.sessionOptions_box)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.pauseSim_button.sizePolicy().hasHeightForWidth())
        self.pauseSim_button.setSizePolicy(sizePolicy)
        ...
        self.horizontalLayout_12.addWidget(self.sessionOptions_box)
        ...
        self.cpdlc_stackedWidget.setCurrentIndex(0)
        self.tabWidget.setCurrentIndex(0)
        self.windHdg_radioButton.toggled['bool'].connect(self.windDirection_widget.setEnabled)
        ...
        self.windCalm_radioButton.toggled['bool'].connect(self.windGusts_widget.setDisabled)
        ...
        teachingConsole.setTabOrder(self.xpdrCode_select, self.squawkVFR_button)
        teachingConsole.setTabOrder(self.squawkVFR_button, self.xpdrIdent_tickBox)
        teachingConsole.setTabOrder(self.xpdrIdent_tickBox, self.pushSQtoStrip_button)
        teachingConsole.setTabOrder(self.pushSQtoStrip_button, self.cpdlcLogOn_button)
        teachingConsole.setTabOrder(self.cpdlcLogOn_button, self.cpdlcTransfer_button)
        teachingConsole.setTabOrder(self.cpdlcTransfer_button, self.cpdlcVectorRequest_toggle)
        teachingConsole.setTabOrder(self.cpdlcVectorRequest_toggle, self.showDataLinkWindow_button)
        teachingConsole.setTabOrder(self.showDataLinkWindow_button, self.onTouchDown_land_radioButton)
    ...
    def retranslateUi(self, teachingConsole):
        ...
        self.squat_tickBox.setText(_translate("teachingConsole", "Squat"))
        ...
        self.cpdlcVectorRequest_toggle.setText(_translate("teachingConsole", "Request next vectors through data link"))
        self.showDataLinkWindow_button.setToolTip(_translate("teachingConsole", "Open current/latest data link window"))
        self.label_6.setText(_translate("teachingConsole", "Latest data link window:"))
        ...
        self.sessionOptions_box.setTitle(_translate("teachingConsole", "Session options"))
        ...
        self.addATC_button.setText(_translate("teachingConsole", "+ ATC"))
