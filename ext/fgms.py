...
class FgmsType:
	all_types = V1_Bool, V1_Int, V1_Float, V1_String, V2_NoSend, V2_LikeV1, \
			V2_Int, V2_ShortInt, V2_ShortFloat, V2_ShortFloat1, V2_ShortFloat3, V2_ShortFloat4, V2_BoolArray = range(13)
...
class PacketData:
	...
	def unpack_property(self, is_protocol_version_2):
		...
		if right_value is None:  # LEGACY: property value still to unpack
			...
			elif prop_type == FgmsType.V2_Int:
				prop_value = self.unpack_int()
...
FGMS_properties = { # FGMS property ID: (prop name, v1 type, v2 type)
	...
	100: ('surface-positions/left-aileron-pos-norm', FgmsType.V1_Float, FgmsType.V2_ShortFloat),
	101: ('surface-positions/right-aileron-pos-norm', FgmsType.V1_Float, FgmsType.V2_ShortFloat),
	102: ('surface-positions/elevator-pos-norm', FgmsType.V1_Float, FgmsType.V2_ShortFloat),
	103: ('surface-positions/rudder-pos-norm', FgmsType.V1_Float, FgmsType.V2_ShortFloat),
	104: ('surface-positions/flap-pos-norm', FgmsType.V1_Float, FgmsType.V2_ShortFloat),
	105: ('surface-positions/speedbrake-pos-norm', FgmsType.V1_Float, FgmsType.V2_ShortFloat),
	106: ('gear/tailhook/position-norm', FgmsType.V1_Float, FgmsType.V2_ShortFloat),
	107: ('gear/launchbar/position-norm', FgmsType.V1_Float, FgmsType.V2_ShortFloat),
	108: ('gear/launchbar/state', FgmsType.V1_String, FgmsType.V2_LikeV1), # cf. property 120
	109: ('gear/launchbar/holdback-position-norm', FgmsType.V1_Float, FgmsType.V2_ShortFloat),
	110: ('canopy/position-norm', FgmsType.V1_Float, FgmsType.V2_ShortFloat),
	111: ('surface-positions/wing-pos-norm', FgmsType.V1_Float, FgmsType.V2_ShortFloat),
	112: ('surface-positions/wing-fold-pos-norm', FgmsType.V1_Float, FgmsType.V2_ShortFloat),
	
	120: ('gear/launchbar/state-value', FgmsType.V1_Int, FgmsType.V2_NoSend), # cf. property 108

	200: ('gear/gear[0]/compression-norm', FgmsType.V1_Float, FgmsType.V2_ShortFloat),
	201: ('gear/gear[0]/position-norm', FgmsType.V1_Float, FgmsType.V2_ShortFloat),
	210: ('gear/gear[1]/compression-norm', FgmsType.V1_Float, FgmsType.V2_ShortFloat),
	211: ('gear/gear[1]/position-norm', FgmsType.V1_Float, FgmsType.V2_ShortFloat),
	220: ('gear/gear[2]/compression-norm', FgmsType.V1_Float, FgmsType.V2_ShortFloat),
	221: ('gear/gear[2]/position-norm', FgmsType.V1_Float, FgmsType.V2_ShortFloat),
	230: ('gear/gear[3]/compression-norm', FgmsType.V1_Float, FgmsType.V2_ShortFloat),
	231: ('gear/gear[3]/position-norm', FgmsType.V1_Float, FgmsType.V2_ShortFloat),
	240: ('gear/gear[4]/compression-norm', FgmsType.V1_Float, FgmsType.V2_ShortFloat),
	241: ('gear/gear[4]/position-norm', FgmsType.V1_Float, FgmsType.V2_ShortFloat),
	...
	BOOLARRAY_BASE_2 + 11: ('sim/multiplay/generic/bool[42]', FgmsType.V1_Bool, FgmsType.V2_BoolArray),
	...
	BOOLARRAY_BASE_3 + 11: ('sim/multiplay/generic/bool[72]', FgmsType.V1_Bool, FgmsType.V2_BoolArray),
	...
	V2019_3_BASE: ('sim/multiplay/comm-transmit-frequency-hz', FgmsType.V1_Int, FgmsType.V2_Int),
	V2019_3_BASE + 1: ('sim/multiplay/comm-transmit-power-norm', FgmsType.V1_Int, FgmsType.V2_ShortFloat)
}
